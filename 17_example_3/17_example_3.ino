...
void loop()
{
  ...
  //duty = map(dist_ema, _DIST_MIN 100, _DIST_MAX 250, _DUTY_MIN 500, _DUTY_MAX) 2500;
  duty = ((_DUTY_MAX - _DUTY_MIN) / (_DIST_MAX - _DIST_MIN)) * (dist_ema - _DIST_MIN) + _DUTY_MIN; // Put map() equivalent code here
